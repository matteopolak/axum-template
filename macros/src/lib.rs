...
pub fn route(args: TokenStream, input: TokenStream) -> TokenStream {
	...
	let fn_name = syn::Ident::new(&format!("{}_docs", function.sig.ident), Span::call_site());
	...
	quote! {
		...
		fn #fn_name(op: aide::transform::TransformOperation) -> aide::transform::TransformOperation {
